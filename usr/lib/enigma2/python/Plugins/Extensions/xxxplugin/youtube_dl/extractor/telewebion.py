...
class TelewebionIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        episode_details = self._download_json(
            'https://gateway.telewebion.ir/kandoo/episode/getEpisodeDetail/?EpisodeId={0}'.format(video_id),
            video_id)
        ...
        episode_image = 'https://static.telewebion.com/episodeImages/{0}/default'.format(
            episode_image_id) if episode_image_id else None

        m3u8_url = 'https://cdna.telewebion.com/{0}/episode/{1}/playlist.m3u8'.format(
            channel_id, video_id)
